...
The sample code for the full framework is available in the directory Net46ArraysSamples. The source code is not directly available in the Net46ArraysSamples directory, but is linked instead. The C# source code files are the same as used with the .NET Core samples. 
You can open the solution file Net46ArraysSamples.sln with Visual Studio and work with it.
