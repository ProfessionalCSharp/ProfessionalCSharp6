...
- ParallelSamples
- Net46ParallelSamples

The Net46ParallelSamples directory contains the same source code (using linked files) as the ParallelSamples directory. Use ParallelSamples with .NET Core, Net46ParallelSamples with the full .NET Framework.
You can open and build the Net46ParallelSamples with a default installation of Visual Studio.

To open and build the ParallelSamples solution, you need to install ASP.NET 5 tools in addition to Visual Studio 2015. 
