...
The database that is used with these samples is AdventureWorks. Download AdventureWorks from https://msftdbprodsamples.codeplex.com/.

The .NET Core projects from ADONetSamples is duplicated in Net46ADONetSamples with full .NET Framework projects. The source code files are linked from the Networking project.
