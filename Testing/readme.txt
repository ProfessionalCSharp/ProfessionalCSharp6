ReadMe - Code Samples for Chapter 19, Testing

The sample code for this chapter contains these solutions:
- UnitTestingSamples
- WebApplicationSample

WebApplicationSample is a ASP.NET Core project with ASP.NET 5 RC1. The NuGet packages, namespaces, and a few code lines will change when RC2 is available.

UnitTestingSamples contains both .NET Core as well as .NET Framework (MSBuild) projects for testing both of these project types.
...
When .NET Core RC2 is available, samples from this Chapter will be changed. The xunit tools will change from DNX to dotnet tools.
