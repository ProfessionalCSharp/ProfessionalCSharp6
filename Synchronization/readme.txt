ReadMe - Code Samples for Chapter 22, Task Synchronization

The sample code for this chapter contains these solutions:
- SynchronizationSamples
- Net46SynchronizationSamples

The .NET Core projects from SynchronizationSamples is duplicated in Net46SynchronizationSamples with full .NET Framework projects. Attention! The WinAppTimer (Universal Windows Platform) and SingletonWPF (WPF) are not duplicated, you can find these projects only in SynchronizationSamples.

To open and build the .NET Core projects of SynchronizationSamples, you need to install ASP.NET 5 tools in addition to Visual Studio 2015. 
