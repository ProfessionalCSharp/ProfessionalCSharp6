...
The sample code for the full framework is available in the directory Net46ObjectsAndTypes. The source code is not directly available in the Net46ObjectsAndTypes directory, but is linked instead. The C# source code files are the same as used with the .NET Core samples. 
You can open the solution file CoreCSharpSamples.sln with Visual Studio and work with it.

The sample code for .NET Core is available in the directory ObjectsAndTypes. To use these source files with Visual Studio, you need to install ASP.NET 5 tools in addition to Visual Studio 2015.
